...
public class ChoixNameJoueursCarcassonne extends JFrame {
    public ChoixNameJoueursCarcassonne(int n){
        super();
        setTitle("Choix");
        ...
        JoueurCarcassonne[] listeJoueurs=new JoueurCarcassonne[n];
        for (int i=0;i<n;i++){
            ...
            humain.addActionListener((e) -> {
                ...
                listeJoueurs[Integer.valueOf(num.getText())]=new JoueurCarcassonne(text.getText());
            });
                
            ordinateur.addActionListener((e) -> {
                ordinateur.setVisible(false);
                humain.setVisible(false);
                listeJoueurs[Integer.valueOf(num.getText())]=new JoueurCarcassonne(text.getText(),true);
            });
        ...
        suivant.addActionListener((e) -> {
            this.dispose();
            new JeuViewCarcassonne(listeJoueurs);});
